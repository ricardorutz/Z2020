...
public class SlideshowAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public SlideshowAdapter(Context context, OnItemClickListener itemClickListener) {
        this.mInflater = LayoutInflater.from(context);
        this.mItemClickListener = itemClickListener;
    }

    public SlideshowAdapter(Context context, OnItemClickListener onItemClickListener, ArrayList<AlbumFile> mAlbumFiles) {
        this.mInflater = LayoutInflater.from(context);
